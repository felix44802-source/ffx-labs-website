...
const content = {
  en: {
    ...
    servicesHeading: "Services & Offerings",
    servicesSubheading: "Tailored AI solutions for your business. Reach out for a custom quote on any service or custom combination.",
    services: {
      website: { name: "Website Service", label: "Website", blurb: "An ultra-fast, high-converting site built with custom design so your local customers actually find and trust you.", cta: "Message me for a quote" },
      bot: { name: "WhatsApp Bot Service", label: "WhatsApp Bot", blurb: "Answers customer questions, handles FAQs, books appointments, and captures leads 24/7 directly on WhatsApp.", cta: "Message me for a quote" },
      leads: { name: "Lead Generation Service", label: "Lead Generation", blurb: "Targeted campaigns and automated outreach that deliver pre-qualified leads directly to your WhatsApp or inbox.", cta: "Message me for a quote" },
      bundle: { name: "The Complete Bundle", label: "Website + WhatsApp Bot + Leads", blurb: "Your complete digital presence & growth engine. The site attracts, the bot converts 24/7, and lead gen keeps your pipeline full.", badge: "Most Popular · Recommended Option", cta: "Get a quote on WhatsApp" },
    },
  ...
  es: {
    ...
    servicesHeading: "Servicios y Soluciones",
    servicesSubheading: "Soluciones de IA a la medida de tu negocio. Escríbeme para recibir una cotización personalizada.",
    services: {
      website: { name: "Servicio de Sitio Web", label: "Sitio Web", blurb: "Un sitio web ultra rápido y de alta conversión con diseño personalizado para que tus clientes locales te encuentren y confíen en ti.", cta: "Cotizar por WhatsApp" },
      bot: { name: "Servicio de Bot de WhatsApp", label: "Bot de WhatsApp", blurb: "Responde preguntas de clientes, atiende FAQs, agenda citas y captura prospectos las 24 horas directamente en WhatsApp.", cta: "Cotizar por WhatsApp" },
      leads: { name: "Servicio de Generación de Leads", label: "Generación de Leads", blurb: "Campañas enfocadas y prospección automatizada que entregan clientes calificados listos para comprar directamente en tu WhatsApp.", cta: "Cotizar por WhatsApp" },
      bundle: { name: "El Paquete Completo", label: "Sitio Web + Bot + Leads", blurb: "Tu motor integral de presencia digital y adquisición. El sitio atrae, el bot convierte 24/7 y los leads mantienen tu agenda llena.", badge: "Más Popular · Opción Recomendada", cta: "Cotizar paquete por WhatsApp" },
    },
