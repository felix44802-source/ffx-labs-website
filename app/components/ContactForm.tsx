          ...
          <div role="status" aria-live="polite" className="sr-only">
            {pending
              ...
              : deliveryFailed
                ...
                : errors
                  ? copy.contact.formError
                  : ""}
          </div>
        )}

        {state.ok === true ? (
          <div role="status" aria-live="polite" className="rounded-3xl border border-green-500/40 bg-green-500/10 p-8 text-center shadow-lg">
          ...
          >
            ...
            <form action={formAction} noValidate className="flex flex-col gap-4">
              {deliveryFailed && (
                <div
                  role="alert"
                  className="rounded-2xl border border-red-500/40 bg-red-500/10 px-4 py-3 text-xs leading-relaxed text-red-300"
                >
                  {copy.contact.deliveryFailed}{" "}
                  <a
                    href={whatsappHref}
            ...
            <div className="flex flex-col justify-between rounded-3xl border border-border-subtle bg-[#091216] p-6 text-left">
              <div>
                <span className="font-mono text-[10px] font-bold uppercase tracking-widest text-accent">
                  {copy.contact.directLine}
                </span>
                <h3 className="mt-2 text-lg font-bold text-foreground">
                  {copy.contact.instantChatTitle}
                </h3>
                <p className="mt-2 text-xs text-foreground-muted leading-relaxed">
                  {copy.contact.instantChatBody}
                </p>
              </div>
