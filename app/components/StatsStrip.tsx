...
export function StatsStrip({ copy }: { copy: SiteContent }) {
  return (
    <section className="relative px-6 py-16 md:px-12">
      ...
      >
        {/* Card 1: AI Pipeline */}
        <div className="relative aspect-[4/3] sm:aspect-auto overflow-hidden rounded-2xl border border-[rgba(34,211,238,0.12)] bg-[rgba(10,15,18,0.6)] backdrop-blur-lg p-6 flex flex-col justify-between">
        ...
        {/* Card 5: Efficiency */}
        <div className="rounded-2xl border border-[rgba(34,211,238,0.12)] bg-[rgba(10,15,18,0.6)] backdrop-blur-lg p-6 flex flex-col justify-between sm:col-span-2 lg:col-span-1">
