...
export function About({ copy }: { copy: SiteContent }) {
  return (
    <section id="about" className="relative border-b border-border py-28 px-6 md:px-12">
      <div className="mx-auto max-w-6xl">
        <div className="grid gap-12 lg:grid-cols-[360px_1fr] lg:items-center lg:gap-16">
          {/* Founder Photo Frame */}
          <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-2xl border-2 border-accent/40 bg-card-bg shadow-[0_0_50px_-15px_rgba(212,175,55,0.2)] lg:mx-0">
            <Image
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-[#060907]/80 via-transparent to-transparent" />
            <div className="absolute bottom-4 left-4 right-4 rounded-xl border border-accent/30 bg-[#060907]/80 px-4 py-2.5 backdrop-blur-md">
          ...
          <div>
            ...
            <p className="mt-6 text-base leading-relaxed text-card-muted md:text-lg">
              {copy.about.bio}
            </p>
