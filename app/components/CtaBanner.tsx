    ...
    <section className="relative py-24 px-6 md:px-12">
      <div className="mx-auto max-w-5xl">
        <motion.div
          ...
          className="rounded-3xl border border-accent/30 bg-gradient-to-br from-[#091216] to-[#040e13] p-12 text-center shadow-[0_20px_60px_-15px_rgba(6,182,212,0.25)] md:p-16"
        >
