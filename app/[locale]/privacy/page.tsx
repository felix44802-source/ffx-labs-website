    ...
    <div className="relative z-10 flex min-h-screen flex-col">
      ...
      <main className="flex-1 px-6 py-24 md:px-12">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-3xl font-extrabold text-foreground md:text-4xl">{privacy.title}</h1>
          <p className="mt-3 font-mono text-xs text-foreground-muted">{privacy.updated}</p>
